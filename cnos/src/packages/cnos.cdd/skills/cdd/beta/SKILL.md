...
- `CDD.md` β steps 1–5 → intake (receive, git identity, subscribe, load skills, read PR/issue)
...
- `CDD.md` β step 10 → β close-out to main at `.cdd/releases/{version}/beta/CLOSE-OUT.md`
